...
def downsampleAmplicons(appRoot, R1_FASTQ, R2_FASTQ, READS_PER_AMPLICON, SHORT_AMPLICON_FASTA_REF):
    ...
    with open(LOG_DIR + '/bbmerge.log', 'w') as f:
        subprocess.call([bbmerge,
                         ...
                         'trimq=20', # 11/28/18 - RVM added quality trim and removed the force trim from left; trimq trims after merging, qtrim trims after 10/29/19 RVM readded the forcetrimleft 
